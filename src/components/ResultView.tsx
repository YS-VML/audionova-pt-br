...
export default function ResultView({ onLegalClick }: ResultViewProps) {
  ...
  const getTitle = () => {
    switch (scoreLevel) {
      case 1: return <>Você pode ter <span>perda de audição</span></>;
      case 2: return <>Sua audição precisa de uma <span>consulta mais detalhada</span></>;
      case 3: return <>Sua audição parece <span>excelente</span></>;
  ...
  const handleShare = () => {
    const shareMessages = [
      "Descubra como está sua audição. Faça o teste com a AudioNova.",
      "Você consegue ouvir? Explore sua audição com a AudioNova.",
      "Tem 20 segundos? Teste sua audição com a AudioNova."
    ];
      ...
      <div className={styles.desktopGrid}>
        ...
        <div className={`${styles.card} ${styles.resultCard} ${styles.fadeIn}`} style={{ animationDelay: '0.1s' }}>
          <div className={styles.resultGraph}>
            <div className={styles.gaugeContainer}>
              ...
              <div className={styles.resultLabel}>Seu resultado</div>
            </div>
          </div>

          <div className={styles.resultActions}>
            {scoreLevel === 1 && (
              <button className={styles.button} onClick={() => window.open('https://www.audionova.com.br/agendamento/', '_blank')}>
                Agende agora sua consulta
              </button>
            )}
            {scoreLevel === 2 && (
              <button className={styles.button} onClick={() => window.open('https://hearing-screener.beyondhearing.org/deoa7u/welcome', '_blank')}>
                Teste sua audição
              </button>
            )}
        ...
        {scoreLevel === 1 ? (
          <div className={`${styles.card} ${styles.fadeIn}`} style={{ animationDelay: '0.2s' }}>
            <div className={styles.cardLabel}>Recomendado para você</div>
            ...
            <a href="https://www.audionova.com.br/aparelhos-auditivos/phonak-virto-r-infinio/" className={styles.outlineButton} target="_blank">Saiba mais sobre o Virto R Infinio</a>
          </div>
        ) : scoreLevel === 2 ? (
          <div className={`${styles.card} ${styles.articleCard} ${styles.fadeIn}`} style={{ animationDelay: '0.2s' }}>
            ...
            <div className={styles.articleContent}>
              <div className={styles.cardLabel}>Recomendado para você</div>
              <h2 className={styles.cardTitle}>Saiba quando fazer o teste</h2>
              <p className={styles.articleDescription}>
                Muitos não sabem quando fazer um teste de audição a menos que tenham problemas para ouvir. Vamos mudar isso.
              </p>
              <button className={styles.outlineButton} onClick={() => window.open('https://www.audionova.com.br/teste-auditivo/quando-fazer/', '_blank')}>
                Ler o artigo
              </button>
            </div>
          </div>
          ...
          <div className={`${styles.card} ${styles.articleCard} ${styles.fadeIn}`} style={{ animationDelay: '0.2s' }}>
            <div className={styles.articleImageContainer}>
              <Image 
                ...
                alt="Testes auditivos regulares" 
                width={320} 
                height={200} 
                className={styles.articleImage}
              />
            ...
            <div className={styles.articleContent}>
              <div className={styles.cardLabel}>COMO PROTEGER SUA AUDIÇÃO</div>
              <h2 className={styles.cardTitle}>Passos para prevenir a perda de audição</h2>
              {/* <p className={styles.articleDescription}>
                Know When to Get Checked
                Many don't know when to get a hearing test unless they have trouble hearing. Let’s change that.
              </p> */}
              <button className={styles.outlineButton} onClick={() => window.open('https://www.audionova.com.br/protecao-auditiva/', '_blank')}>
                Ler o artigo
              </button>
            </div>
          </div>
        ...
        <div className={`${styles.card} ${styles.fadeIn}`} style={{ animationDelay: '0.3s' }}>
          <div className={styles.cardLabel}>Precisa de ajuda?</div>
          <h2 className={styles.cardTitle}>Fale com nossos especialistas em cuidados auditivos</h2>
          <div className={styles.contactList}>
            <div className={styles.contactItem}>
              <Image src="/icons/location.svg" alt="" width={24} height={24} />
              <a href="https://www.audionova.com.br/clinicas/buscar/" target="_blank">Encontre uma clínica</a>
            </div>
            <div className={styles.contactItem}>
            ...
            <div className={styles.contactItem}>
              ...
              <a href="mailto:atendimento@audionova.com.br">
                atendimento@audionova.com.br
              </a>
            </div>
          </div>
          <a
            href="https://wa.me/551140038430"
            target="_blank"
